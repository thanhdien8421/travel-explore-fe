...
export default function NotFoundUI({ 
  ...
  description = "Xin lỗi, trang bạn đang tìm kiếm không tồn tại hoặc đã được chuyển đi. Hãy quay lại trang chủ để tiếp tục khám phá.",
  showNavBar = true
}: NotFoundUIProps) {
  return (
    <div className="min-h-screen bg-[rgb(250,250,250)]">
      {showNavBar && <NavBar onSearchClick={() => {}} />}

      <div className={`${showNavBar ? 'min-h-[calc(100vh-80px)]' : 'min-h-screen'} flex items-center justify-center px-4`}>
