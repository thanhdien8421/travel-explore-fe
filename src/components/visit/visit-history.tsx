...
export default function VisitHistoryPage({ isModal = false }: VisitHistoryPageProps) {
    ...
    return (
      <div className="bg-white rounded-2xl shadow-md p-4 sm:p-8">
        <div className="bg-red-50 border border-red-200 rounded-lg p-4 sm:p-6 text-center">
          <svg
            className="w-10 sm:w-12 h-10 sm:h-12 text-red-300 mx-auto mb-3 sm:mb-4"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
  ...
  if (visits.length === 0) {
    return (
      <div className="bg-white rounded-2xl shadow-md p-4 sm:p-8 text-center">
        <svg
        ...
        <p className="text-gray-600 mb-2 sm:mb-4 text-sm sm:text-lg font-medium">
        ...
        <Link
          href="/locations"
          className="inline-block px-4 sm:px-6 py-2 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-semibold rounded-lg hover:from-blue-700 hover:to-blue-800 transition-all text-sm sm:text-base"
        >
          Khám phá địa điểm
        </Link>
      </div>
  ...
  return (
    <div className="bg-white rounded-2xl shadow-md overflow-hidden">
      {/* Header */}
      <div className="bg-gradient-to-r from-blue-50 to-blue-100 border-b border-blue-200 px-4 sm:px-6 py-3 sm:py-4">
        ...
        {visits.map((visit, index) => {
          ...
          return (
            <Link
              ...
              className="block p-3 sm:p-4 hover:bg-gray-50 transition-colors duration-200"
            >
              <div className="flex gap-3 sm:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <h4 className="font-semibold text-sm sm:text-base text-gray-900 truncate group-hover:text-blue-600">
                    {visit.place.name}
                  </h4>
                ...
                {/* Arrow Icon */}
                <div className="flex items-center justify-center text-gray-400 group-hover:text-gray-600 flex-shrink-0">
                  <svg
