...
export default function MapPage() {
                    ...
                    const popupContent = `
                        <div class="w-48 sm:w-56 md:w-64 overflow-hidden rounded-lg">
                            ...
                            <div class="p-2 sm:p-3 bg-white">
                                ...
                                <p class="text-[10px] sm:text-xs text-gray-600 line-clamp-3 sm:line-clamp-5 mb-2 sm:mb-3">${place.description || 'Khám phá địa điểm thú vị này'}</p>
                                <a href="/locations/${place.slug}" class="block w-full text-end text-white px-2 sm:px-3 py-1.5 sm:py-2 rounded-lg text-[10px] sm:text-xs font-medium hover:bg-gray-600/10 transition-colors">
                                    Xem chi tiết →
                                </a>
                            </div>
                        </div>
    ...
    return (
        <div className="w-full h-screen bg-white flex flex-col">
            ...
            <div className="absolute top-20 left-1/2 transform -translate-x-1/2 z-40 bg-transparent pointer-events-none w-full px-4 sm:w-auto sm:px-0">
                <div className="py-4 flex flex-col sm:flex-row gap-3 items-stretch sm:items-center pointer-events-auto">
            ...
            {searchQuery && !sidebarOpen && (
                <button
                    ...
                    className="absolute top-24 right-4 z-[1000] bg-white text-gray-800 p-2 rounded-lg hover:bg-gray-100 transition-colors shadow-lg"
            ...
            <div className="flex-1 relative w-full h-full overflow-hidden">
                ...
                <div
                    className={`absolute top-0 right-0 bottom-0 w-full sm:w-72 md:w-80 bg-white border-l border-gray-200 flex flex-col transition-transform duration-300 ease-in-out z-[1000] pointer-events-auto ${
                        sidebarOpen && searchQuery ? "translate-x-0" : "translate-x-full pointer-events-none"
                    }`}
                    style={{
